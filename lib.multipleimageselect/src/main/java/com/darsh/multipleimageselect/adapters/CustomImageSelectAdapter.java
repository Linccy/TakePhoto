...
//            ((FrameLayout) convertView).setForeground(context.getResources().getDrawable(R.drawable.image_selected));
            convertView.findViewById(R.id.image_btn_selector).setSelected(true);
        } else {
            viewHolder.view.setAlpha(0.0f);
            ((FrameLayout) convertView).setForeground(null);
//            ((FrameLayout) convertView).setForeground(context.getResources().getDrawable(R.drawable.image_un_select));

            convertView.findViewById(R.id.image_btn_selector).setSelected(false);
